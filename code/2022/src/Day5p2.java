...
public class Day5p2 {
    public static void main(String[] args) throws Exception {
        ...
        for(int i = 10; i<myList.size(); i++) {
            ...
            // temporary stack to store the crates to be moved
            Stack<Character> tempStack = new Stack<>();

            // move the stack(s) from initial stack number to tempStack
            for(int j=0; j<move; j++) {
                Character crate = myStacks.get(from).pop();
                tempStack.push(crate);
            }

            // move the stack(s) from tempStack to end stack number
        ...
        // solution for my input is TPFFBDRJD
